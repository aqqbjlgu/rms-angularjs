app.controller('OrgCtrl', ['$scope', '$http', 'i18nService', 'ngDialog', 'toaster', '$state', 'orgService', function ($scope, $http, i18nService, ngDialog, toaster, $state, orgService) {
    i18nService.setCurrentLang('zh-cn');
    $scope.orgType = {};
    $scope.selectOrgTypes = [];
    $scope.addFlag = true;
    var getPage = function (curPage, pageSize) {
        orgService.getAll(curPage, pageSize).then(function (data) {
    ...
    $scope.gridOptions = {
        ...
        paginationPageSizes: [3, 50, 100], //每页显示个数可选项
    ...
    $scope.add = function () {
        orgService.save($scope.orgType).then(function (data) {
            if(data.success){
    ...
    $scope.delete = function () {
        ...
        swal({
            ...
            orgService.delete(ids).then(function (data) {
                if(data.success){
